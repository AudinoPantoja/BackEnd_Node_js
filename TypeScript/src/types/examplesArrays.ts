...
//para sacar un valor especifico
const index = numberOne.indexOf(3)
console.log('El indice es ', index)
//ubiquese en la posicion y el segundo el limite
...
//hace un recorrido para filtrar la condicion dada
...
//every entrega un true o false

//some alguno cumple una condicion
...
//Es lo mismo
const combinedArrayPush = array1.push(...array2);
